...
function checkGameOver() {
	for (var i = 0; i < MainHex.sides; i++) {
		if (isInfringing(MainHex)) {
			//$.get('https://www.getdoozy.com/' + String(score))
...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>HOW TO PLAY</div><p>The goal of doozy is to stop blocks from leaving the inside of the outer gray hexagon.</p><p>" + (settings.platform != 'mobile' ? 'Press the right and left arrow keys' : 'Tap the left and right sides of the screen') + " to rotate the Hexagon." + (settings.platform != 'mobile' ? ' Press the down arrow to speed up the block falling': '') + " </p><p>Clear blocks and get points by making 3 or more blocks of the same color touch.</p><p>Time left before your combo streak disappears is indicated by <span style='color:#f1c40f;'>the</span> <span style='color:#e74c3c'>colored</span> <span style='color:#3498db'>lines</span> <span style='color:#2ecc71'>on</span> the outer hexagon</p> <hr> <p id = 'afterhr'></p> <center> <a href='https://p-y.tm/A-693Ng' target='_blank' style='border-radius: 2px;display: inline-block;border: 1px solid #e6ebf3;padding: 6px 23px;color: #182233;font-size: 12px;text-decoration: none;font-family: Nunito Sans, sans-serif;background: #ffffff;border: 1px solid #e8edf4;color: #182233;'> <span>Donate Rs 5 with</span> <img style='margin-left: 6px;vertical-align:sub;width: 50px;' src='https://static1.paytm.in/1.4/plogo/paytmlogo-coloured.png' /></a> </center>");
	if (gameState == 1) {
		pause();
	}
